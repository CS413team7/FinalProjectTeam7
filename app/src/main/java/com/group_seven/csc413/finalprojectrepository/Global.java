...
public class Global extends Application
{
    ...
    private DBConfig databaseContext;
     ...
     *                ((Global) this.getApplication()).setDatabaseContext(DatabaseConfig.loadDbConfiguration(this));
     *
     * @see           com.group_seven.csc413.finalprojectrepository.DBConfig
     */
    public void setDatabaseContext(DBConfig dbc)
    {
        databaseContext = dbc;
    }
     ...
     * @see           com.group_seven.csc413.finalprojectrepository.DBConfig
     */
    public DBConfig getDatabaseContext()
    {
